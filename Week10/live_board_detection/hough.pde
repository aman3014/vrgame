List<PVector> hough(PImage edgeImg) {
  ...
  int minVotes = HOUGH_VOTES_CUTOFF;    //..../../.../..../..,-----,
  //../../.../....//´...........`.
  //./../.../..../......../´¯\....\
  //('.('..('....('.......|.....'._.'
  //.\....................`\.../´...)
    ...
    for (int x = 0; x < edgeImg.width; x++) {
      ...
      if (brightness(edgeImg.pixels[y * edgeImg.width + x]) != 0) {
        ...
        for (int phi = 0; phi < phiDim; ++phi) {
          float actual_phi = phi * discretizationStepsPhi;
          double actual_r = x * cos(actual_phi) + y * sin(actual_phi);
          int r = (int) (actual_r / discretizationStepsR);
          r += rDim / 2;
